(function () {
    ...
    function initChatbot() {
        ...
        function sendMessage() {
            ...
            fetch(apiUrl, {
                ...
                .catch(function () {
                    removeTypingIndicator();
                    appendMessage(messagesEl, "bot", "Error: Could not connect to chatbot service. Ensure Ollama is running.");
                })
                .finally(function () {
    ...
    function enhanceToggle(toggleBtn) {
        if (!toggleBtn) {
            return;
        }

        toggleBtn.innerHTML = '<i class="fa-solid fa-comments" aria-hidden="true"></i>';
