...
<nav class="navbar navbar-expand-lg glass-nav" data-tour-step="1" data-tour-title="Report Page Navigation" data-tour-text="This top navigation keeps the main routes close while you work, including returning home, opening your dashboard, tracking complaints, and switching language.">
    <div class="container py-2">
        <a class="navbar-brand d-flex align-items-center gap-3 fw-semibold" href="../index.php">
            ...
            <span class="navbar-brand-text">
                ...
                <small data-i18n="report.brand_tagline">Secure incident submission</small>
            </span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="reportNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1 me-lg-3">
                ...
                <li class="nav-item"><a class="nav-link app-nav-link active" href="report.php"><span data-i18n="common.nav_report">Report Crime</span></a></li>
                <li class="nav-item"><a class="nav-link app-nav-link" href="dashboard.php"><span data-i18n="common.nav_dashboard">Dashboard</span></a></li>
                <li class="nav-item"><a class="nav-link app-nav-link" href="dashboard.php#complaint-history"><span data-i18n="common.nav_track">Track Complaint</span></a></li>
                ...
                <li class="nav-item"><a class="nav-link app-nav-link" href="logout.php"><span data-i18n="common.nav_logout">Logout</span></a></li>
            </ul>
            <div class="d-grid d-lg-flex gap-2">
                <div class="language-switcher-wrap">
                    <label class="visually-hidden" for="reportLanguageSwitcher" data-i18n="common.lang_label">Language</label>
                    <div class="language-switcher-shell">
                        <i class="fa-solid fa-language" aria-hidden="true"></i>
                        <select id="reportLanguageSwitcher" class="language-switcher-select" aria-label="Language switcher" data-google-translate-switcher>
                            <option value="en">English</option>
                            <option value="hi">हिंदी</option>
                        </select>
                    </div>
                </div>
                <a href="dashboard.php" class="btn btn-outline-primary"><span data-i18n="report.my_dashboard">My Dashboard</span></a>
            </div>
        </div>
    </div>
</nav>
...
<main class="container py-4 py-lg-5">
    <div class="page-topbar">
        <div class="page-breadcrumb">
            <a href="../index.php" data-i18n="common.nav_home">Home</a>
            <i class="fa-solid fa-chevron-right small"></i>
            <a href="dashboard.php" data-i18n="report.breadcrumb_dashboard">Dashboard</a>
            <i class="fa-solid fa-chevron-right small"></i>
            <span class="current" data-i18n="report.breadcrumb_current">Report Crime</span>
        </div>
    ...
    <section class="surface-card p-4 p-lg-5 mb-4" data-tour-step="2" data-tour-title="Complaint Overview" data-tour-text="This intro card explains the reporting flow so a new user understands that they need incident details, a location, and optional evidence before submitting.">
        <div class="row g-4 align-items-center">
            <div class="col-lg-7">
                <p class="text-uppercase small fw-semibold text-primary mb-2" data-i18n="report.hero_label">Submit Complaint</p>
                <h1 class="section-title mb-2" data-i18n="report.hero_title">Report a crime with verified location details</h1>
                <p class="section-copy mb-0" data-i18n="report.hero_copy">Search the location first, refine the pin on the map if needed, upload evidence, and submit the complaint into the existing reporting workflow.</p>
            </div>
            <div class="col-lg-5">
                <div class="surface-card p-4">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            <h5 class="mb-1" data-i18n="report.side_title">Smarter location selection</h5>
                            <p class="muted mb-2" data-i18n="report.side_copy">Search a landmark or address, click anywhere on the map, or drag the marker to adjust the exact point.</p>
                            <div class="small muted" data-i18n="report.side_note">The address panel and coordinates update automatically.</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <form method="POST" enctype="multipart/form-data" data-loading-target="#reportLoading" class="needs-validation" novalidate>
        ...
        <div class="row g-4">
            <div class="col-xl-6">
                <div class="card form-card h-100" data-tour-step="3" data-tour-title="Incident Details Form" data-tour-text="Fill in the crime type, write what happened, and upload evidence if you have it. These details become part of the official complaint record.">
            ...
            <div class="col-xl-6">
                <div class="card form-card h-100" data-tour-step="4" data-tour-title="Map and Location" data-tour-text="Search for a place or click on the map to mark the incident location. The portal stores the coordinates and resolved address automatically.">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <div>
...
<div id="crimeChatbot" class="chatbot-widget" data-api-url="../chatbot/chatbot_api.php" data-logo-src="../assets/img/bot_logo.png" data-tour-step="5" data-tour-title="Help While Reporting" data-tour-text="If you are unsure about evidence, location selection, or complaint steps, open the chatbot for quick help without leaving the form.">
